...
output logic PWM_rev_lft,PWM_rev_rght,PWM_frwrd_rght,PWM_frwrd_lft; //The PWM for each wheel
							//Each wheel has
							//a forward
							//and reverse signal
							//Only one for each
...
logic set_lf,reset_lf,set_rt,reset_rt; //Internal signals for maintaining PWM signals
logic [10:0] cnt;	//Counter used to manage PWM
