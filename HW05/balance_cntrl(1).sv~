module balance_cntrl(clk,rst_n,vld,ptch,ld_cell_diff,lft_spd,lft_rev,
  ...
  input en_steer;
  input pwr_up					// comes from auth_blk used to enable device
  ...
  output too_fast				// signal asserted if lft_spd or rght_spd greater than 1536
  ...
  /////////////////////////////////////////////////////////
  // parameter that can be passed in for integral speed //
  ///////////////////////////////////////////////////////
  ...
  assign integrator_ext = (fast_sim) ? integrator[17:2] : {{4{integrator[17]}}, integrator[17:6]}; //sign extend [17:6] if not fast_sim, otherwise just integrator[17:2]
  ...
  assign lft_spd =  (!pwr_up)                ? 11'h000 :                       ///when not enabled make 0
	            (|lft_shaped_abs[15:11]) ? 11'h7FF : lft_shaped_abs[10:0]; //saturate
  ...
  assign rght_spd =  (!pwr_up)                 ? 11'h000 :                        //when not enabled make 0 
	             (|rght_shaped_abs[15:11]) ? 11'h7FF : rght_shaped_abs[10:0]; //saturate

  assign rght_rev = rght_shaped[15]; //forward or backwards (+/-)


  /////////////// CLEANED UP: too fast signal ////////////////
  assign too_fast = (lft_spd > 1536 || rght_spd > 1536) ? 1'b1 : 1'b0; 
